import { X, Info, Calendar, Plane, ShieldCheck, SquarePen } from 'lucide-react';
...
export default function GroupDetailsModal({
  ...
  const data: GroupDetailsModalData = {
    ...
    transportCompany: group?.transportCompany || (isRTL ? 'شركة حافلات مكة' : 'Makkah Buses Co.'),
        ...
        <div className="px-6 sm:px-8 py-5 space-y-5 overflow-y-auto flex-1 bg-white">
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="bg-[#f8fafc] border border-slate-200/70 rounded-xl px-4 py-2.5 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-normal">{t('groups.col_code', 'رقم المجموعة')}</span>
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="bg-[#f8fafc] border border-slate-200/70 rounded-xl px-4 py-2.5 flex items-center justify-between">
                ...
                <span className="text-xs sm:text-sm font-bold text-slate-800">{data.transportCompany}</span>
              </div>

              <div className="bg-[#f8fafc] border border-slate-200/70 rounded-xl px-4 py-2.5 flex items-center justify-between">
                <span className="text-xs text-slate-400 font-normal">{isRTL ? 'رقم التشغيل' : 'Operation Code'}</span>
                <span className="text-xs sm:text-sm font-bold text-slate-800 font-mono">{data.operationNumber}</span>
              </div>
            </div>
          </div>
